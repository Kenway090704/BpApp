 ...
 */
public class OnlineTasksListFragment extends BaseViewFragmentImpl<TasksListBinding> implements TaskContract.View , TasksCenterUI.TaskRefreshCallback{

    private static final String TAG = "UI.OnlineTasksListFragment";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        present = new TaskPresent(new TaskCenterDataSourceRemote(ProtocolConstants.TaskType.ONLINE), this);
    }
