 ...
 */
public class WeeklyGameListFragment extends RetryRequestFragment<UiGameRecordListBinding> implements BGARefreshLayout.BGARefreshLayoutDelegate {

    private static final String TAG = "PersonalCenter.WeeklyGameListFragment";
    ...
    @Override
    public void init() {
        mAdapter = new GamePerformanceAdapter(getActivity().getLayoutInflater(), getString(R.string.personal_center_week_game));
        ...
        mBinding.emptyView.setText(R.string.personal_no_weekly_game);
    ...
    private void updateGameList() {
        netScene = new NetSceneGetAccountGame(ProtocolConstants.GameType.WEEK_GAME, mOffset,
