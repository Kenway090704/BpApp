package com.bemetoy.bp.sdk.arithmetic;
...
public final class MD5 {
	 ...
	 * @return
	 */
	public final static String getMD5(final InputStream is, final int bufLen, final int offset, final int length) {
	 ...
	 * @param length
	 * @param extendBytes
	 *            extend bytes which would be add to the end of input stream for MD5 calculating
	 * @return
	 */
	public final static String getMD5ExtendBytes(final InputStream is, final int bufLen, final int offset, final int length, final byte[] extendBytes) {
	 ...
	 * @return
	 */
	public final static String getMD5(final InputStream is, final int bufLen) {
		if (is == null || bufLen <= 0) {
			return null;
		}
		try {
