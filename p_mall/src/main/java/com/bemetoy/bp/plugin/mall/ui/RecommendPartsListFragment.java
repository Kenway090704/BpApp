...
/**
 * Created by tomliu on 16-9-19.
 */
public class RecommendPartsListFragment extends BaseViewFragmentImpl<UiPartsListBinding> implements MallContract.View {
    ...
    public static RecommendPartsListFragment getInstance() {
